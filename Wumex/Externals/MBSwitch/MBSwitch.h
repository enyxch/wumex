...
@property(nonatomic, retain) NSString *textOn;
@property(nonatomic, retain) NSString *textOff;
@property(nonatomic, assign) UIColor *textOnColor UI_APPEARANCE_SELECTOR;
@property(nonatomic, assign) UIColor *textOffColor UI_APPEARANCE_SELECTOR;
