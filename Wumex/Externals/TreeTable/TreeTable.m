...
- (id)init {
	...
	if (self) {
		...
		self.closingAnimation = UITableViewRowAnimationFade;
		self.expandingAnimation = UITableViewRowAnimationFade;
	}
	return self;
}
...
- (void)expand:(NSIndexPath *)indexPath {
	...
	[self insertRowsAtIndexPaths:insertRows withRowAnimation:UITableViewRowAnimationFade];
}
...
- (void)collapse:(NSIndexPath *)indexPath {
	...
	[self deleteRowsAtIndexPaths:dismissRows withRowAnimation:UITableViewRowAnimationFade];
}
