...
@interface TKDragView : UIView <UIGestureRecognizerDelegate> {
    ...
    struct {
        ...
        unsigned int dragViewWillMove:1;
        unsigned int dragViewDidMove:1;
...
@property (nonatomic) BOOL isHorizontalDraggable;


@property (nonatomic) CGPoint offsetStartLocation;
...
- (void)dragViewWillMove:(TKDragView *)dragView;
