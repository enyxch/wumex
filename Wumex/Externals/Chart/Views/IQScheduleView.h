...
@interface IQTaskView : TKDragView <WYPopoverControllerDelegate>{
@private
    UILabel* textLabel;
    WYPopoverController *settingsPopoverController;
}

- (instancetype)initWithFrame:(CGRect)frame subFrames:(NSArray*)frames;
...
@interface IQLabelView : TKDragView <WYPopoverControllerDelegate>{
@private
    UILabel* textLabel;
    WYPopoverController *settingsPopoverController;
}
