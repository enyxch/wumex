...
- (id)initWithFrame:(CGRect)frame andImages:(NSDictionary *)images withOptions:(PSAnalogClockViewOption)options
{
    ...
    if (self) {
        ...
        [_calendar setTimeZone:[NSTimeZone timeZoneWithName:@"GMT"]];
        _options  = options;
...
- (void)updateClockTimeWithDate:(NSDate*)date animated:(BOOL)animated
{
    [self addImageViews];
...
- (NSInteger)hours
{
    return [[_calendar components:NSHourCalendarUnit fromDate:self.now] hour];
}
